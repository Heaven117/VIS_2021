<template>
  <div class="main">
    <div id="pollutionChart" style="width:100%; height: 100%"></div>
  </div>
</template>
...
import {getProvinceByYear} from "@/request/api";
...
//       ];
      ...
      var option = {
        ...
        series: [
          {
            name: this.$store.state.province2,
            type: 'parallel',
            lineStyle: lineStyle,
